const checkStatus = (response) => {
  ...
  class ToDoList extends React.Component {
    ...
    fetchTasks() {
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=515")
        .then(checkStatus)
        .then(json)
        .then((response) => {
    ...
    deleteTask(id) {
      ...
      fetch(`https://altcademy-to-do-list-api.herokuapp.com/tasks/${id}?api_key=515`, {
        method: "DELETE",
        mode: "cors",
      }).then(checkStatus)
        .then(json)
    ...
    toggleComplete(id, completed) {
      ...
      fetch(`https://altcademy-to-do-list-api.herokuapp.com/tasks/${id}/mark_${newState}?api_key=515`, {
        method: "PUT",
        mode: "cors",
      }).then(checkStatus)
        .then(json)
